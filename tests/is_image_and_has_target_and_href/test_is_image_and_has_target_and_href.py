...
def test_image_has_href(browser_page):
    ...
    element = page.locator(
        'img[alt="иконка карточки"].a2lPS.e2lPS[loading="lazy"][height="40"][src="https://alfabank.servicecdn.ru/media/main-page-assets/main-page_selfemployed-icon.svg"][width="40"]').nth(index).element_handle()
